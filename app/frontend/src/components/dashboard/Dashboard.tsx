    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-300">Here's what's happening in your professional network today.</p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-sm text-gray-900 dark:text-white">You published a new post about React performance optimization</p>
            ...
            <div className="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-sm text-gray-900 dark:text-white">Sarah Johnson accepted your connection request</p>
            ...
            <div className="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-sm text-gray-900 dark:text-white">New job opportunity: Senior Frontend Developer at TechCorp</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={index} className="flex items-center space-x-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                <button className="px-3 py-1 bg-blue-600 dark:bg-blue-700 text-white text-xs rounded-md hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors">
                  Connect
                </button>
              </div>
            ))}
